...
@Tags({"Ericsson", "Binary", "JSON"})
@CapabilityDescription("Converts Ericsson binary stream to JSON format")
@SeeAlso({HuaweiBinaryCSVMergeProcessor.class, HuaweiBinaryJSONProcessor.class, EricssonBinaryCSVMergeProcessor.class})
public class EricssonBinaryJSONProcessor extends AbstractBinaryProcessorBase {


//    @Override
//    protected DecoderInput buildDecoderInput(byte[] inputBytes, OutputStream os, String inputFileName, String outputFileName) {
//        final DecoderInput decoderInput = new DecoderInput(inputBytes, 1,1)
//                .addChannel(new OutputChannel(Ericsson2JsonDecoder.ALL_CHANNEL, os));
//        return decoderInput;
//    }

    @Override
    protected DecoderBase buildDecoder() {
        final Ericsson2JsonDecoder decoder = new Ericsson2JsonDecoder();
        return decoder;
    }

//    @Override
//    protected String getOutChannelName() {
//        return Ericsson2JsonDecoder.ALL_CHANNEL;
//    }
